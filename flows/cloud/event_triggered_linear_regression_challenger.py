...
from metaflow import FlowSpec, project, step, card, conda_base, current, Parameter, Flow, trigger
...
class TaxiFarePrediction(FlowSpec):
    ...
    def start(self):
        ...
        self.X = self.df[["trip_distance", "passenger_count", "airport_fee", "tolls_amount", "congestion_surcharge"]].values
    ...
    def xgb_model(self):
        ...
        self.model = xgb.XGBRegressor(max_depth=4, nthread=8)
